...
#define CAN_ID_NODE1_TX   	0x012
#define CAN_ID_NODE1_RX   	0x0A2
#define CAN_ID_NODE2_TX     0x0A2
#define CAN_ID_NODE2_RX		0x012
#define CAN_DLC     		8
#define NODE1_TX_CYCLE		4000 // 4s cycle
#define NODE2_TX_CYCLE		50
